...
This is Sage code for the complexity analysis of Section 4 of the preprint "On the Impact of Faster Sparse Linear Algebra on the Number Field Sieve" by Desirée Gijón Gómez.
